...
type ReviewResult = { correct: boolean; submitted: string };
...
export default function Home() {
  ...
  const gradeReview = () => {
    if (!review || reviewResult) return; const submitted = reviewDraft[review.id] ?? ""; const correct = submitted.toLowerCase() === review.gap.expected.toLowerCase();
    setReviewResults(previous => ({ ...previous, [review.id]: { correct, submitted } }));
